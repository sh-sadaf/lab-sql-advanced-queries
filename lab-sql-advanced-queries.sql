...
select concat(a1.first_name, " ",a1.last_name ) as a1_actor_name, concat(a2.first_name, " ", a2.last_name) as a2_actor_name, fa1.actor_id, fa2.actor_id, fa1.film_id, fa2.film_id
